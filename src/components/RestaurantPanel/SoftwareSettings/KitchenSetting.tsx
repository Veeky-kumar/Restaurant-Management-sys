...
const KitchenSetting: React.FC = () => {
    return (
        <div className="" id="v-pills-messages" role="tabpanel" aria-labelledby="v-pills-messages-tab">
            <div className="tab-set">
                <h4> Receipt/Kitchen Setting </h4>
                ...
                <div className="form-check form-set">
                    <label className="form-check-label" htmlFor="exampleRadios1">
                        ...
                        <button type="button" className="btn tootipCustomClass" data-toggle="tooltip" data-placement="bottom" title="" data-bs-original-title="AUTO ORDER NUMBER">
                            <i className="fa fa-question-circle" aria-hidden="true"></i>
                        </button>
                        <i className="input-helper"></i>
                        <i className="input-helper"></i></label>
                ...
                <div className="form-check form-set">
                    <label className="form-check-label" htmlFor="exampleRadios1">
                        ...
                        <button type="button" className="btn tootipCustomClass" data-toggle="tooltip" data-placement="bottom" title="" data-bs-original-title="MANUAL ORDER NUMBER FOR EVERY DAY">
                            <i className="fa fa-question-circle" aria-hidden="true"></i>
                        </button>
                        <i className="input-helper"></i>
                        <i className="input-helper"></i></label>
                ...
                <div className="form-check form-set">
                    <label className="form-check-label" htmlFor="exampleRadios1">
                        <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 50 50">
                            <g id="print_order_number_on_reciept" data-name="print order number on reciept" transform="translate(9193 -3784)">
                                ...
                                <g id="reciept-financial-report-svgrepo-com" transform="translate(-9441 3578.19)">
                                    ...
                                    <path id="Path_64839" data-name="Path 64839" d="M258,212.81c2.511,0,2.511,2.739,5.021,2.739s2.511-2.739,5.021-2.739,2.511,2.739,5.021,2.739,2.511-2.739,5.022-2.739,2.51,2.739,5.021,2.739,2.511-2.739,5.022-2.739" fill="none" stroke="#5d5d5d" stroke-linecap="round" stroke-miterlimit="10" stroke-width="2.5"></path>
                                    <path id="Path_64840" data-name="Path 64840" d="M288.208,746.979c-2.511,0-2.511-2.739-5.021-2.739s-2.511,2.739-5.021,2.739-2.511-2.739-5.021-2.739-2.511,2.739-5.022,2.739-2.51-2.739-5.021-2.739-2.511,2.739-5.022,2.739" transform="translate(-0.075 -498.344)" fill="none" stroke="#5d5d5d" stroke-linecap="round" stroke-miterlimit="10" stroke-width="2.5"></path>
                        ...
                        </svg>PRINT ORDER NUMBER ON RECIEPT
                        <button type="button" className="btn tootipCustomClass" data-toggle="tooltip" data-placement="bottom" title="" data-bs-original-title="PRINT ORDER NUMBER ON RECIEPT">
                            <i className="fa fa-question-circle" aria-hidden="true"></i>
                        </button>
                        <i className="input-helper"></i>
                        <i className="input-helper"></i></label>
