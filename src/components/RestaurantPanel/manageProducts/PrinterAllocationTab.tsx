    ...
    <div id="PrinterSetup_tab" className="tab-pane fade active show">
      ...
      <div className="product_main-wrap" style={{ paddingTop: '30px', minHeight: '400px' }}>
        <div
          ...
          className="!p-4 sm:!p-6 !px-2 items_chckbox-wraps wrap_product-availability printerAllocationSectionStyle"
        >
          {[
...
<div
  key={printer.id}
  className="product_availability-wrap col-12"
>
  <div className="row flex-wrap">
    <div className="col-2 col-sm-2 col-md-2 col-lg-2 d-flex justify-content-center align-items-center">
      <input
    ...
    <div className="px-2 col-8 col-sm-8 col-md-8 col-lg-8 d-flex align-items-center">
